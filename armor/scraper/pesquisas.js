...
const Horoscopo = (signo) => new Promise((resolve, reject) => {
  axios.get(`https://www.somostodosum.com.br/horoscopo/signo/${signo}.html`, {
      headers: {
        ...useragent_1
      }
    })
    .then((res) => {
      ...
      resolve({
        status: res.status,
        criador: default_criador,
        imagem: 'https://www.somostodosum.com.br/horoscopo' + $('body > div:nth-child(9) > div > div.container > div.col-lg-9 > article > center:nth-child(1) > img').attr('data-cfsrc').slice(2),
